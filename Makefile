...
PACKAGE ?= helm-opentelemetry-operator
XRD_DIR := apis/opentelemetryoperators
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/opentelemetryoperators/standard.yaml
...
EXAMPLES := \
    examples/opentelemetryoperators/minimal.yaml:: \
    examples/opentelemetryoperators/standard.yaml::
...
render\:%:
	@example="examples/opentelemetryoperators/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
